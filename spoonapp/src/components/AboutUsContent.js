    ...
    <div id="about-us-content" className={`fade-element ${isVisible ? 'visible' : ''}`}>
      ...
      <div className="section">
        ...
        <div className="tim">
          ...
          <img src={require('/Users/timkim/Desktop/CMPE133/Recipe-Radar/spoonapp/src/images/Black.png')} alt="Timothy Kim" className="headshot" />
        </div>
        <div className="ryan">
          <h3 className="creator-heading">
            Ryan Tang
          </h3>
          <img src={require('/Users/timkim/Desktop/CMPE133/Recipe-Radar/spoonapp/src/images/Black.png')} alt="Ryan Tang" className="headshot" />
        </div>
        <div className="phat">
          <h3 className="creator-heading">
            Phat Chau
          </h3>
          <img src={require('/Users/timkim/Desktop/CMPE133/Recipe-Radar/spoonapp/src/images/Black.png')} alt="Phat Chau" className="headshot" />
        </div>
      </div>
    </div>
  );
